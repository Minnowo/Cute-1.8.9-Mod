...
{
	public static ArrayList<XRayBlock> Blocks = new ArrayList<XRayBlock>();
	...
	public XRayBlock(int r, int g, int b, int a, int meta, String id, boolean enabled) 
	{
		this.r = r;
		this.g = g;
		this.b = b;
	...
	public static XRayBlock FromString(String str) 
	{
