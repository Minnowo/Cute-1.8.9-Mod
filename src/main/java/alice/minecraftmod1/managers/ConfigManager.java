...
import alice.minecraftmod1.setting.checkbox.*;
import alice.minecraftmod1.setting.keybind.*;
import alice.minecraftmod1.setting.mode.*;
import alice.minecraftmod1.setting.slider.*;
...
public class ConfigManager
{
    ...
    {
        config = new File(Reference.NAME + ".config");
